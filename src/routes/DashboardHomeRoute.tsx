  ...
  return (
    <PageTransition>
      <div className="space-y-8">
        ...
        <DynamicGreeting userName={user?.user_metadata?.full_name?.split(' ')[0] || 'Friend'} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="space-y-6">
            <Card variant="elevated" className="flex flex-col items-center p-6">
              <h3 className="text-lg font-semibold text-neutral-900 dark:text-white mb-4 w-full text-left">Daily Activity</h3>
              <ActivityRings move={75} exercise={50} stand={90} />
            </Card>
