...
export function SignUpForm({ onToggleMode }: SignUpFormProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-white rounded-2xl shadow-lg">
      ...
      <h2 className="text-3xl font-bold text-gray-800 text-center mb-2">Join Lyfora</h2>
      <p className="text-gray-600 text-center mb-8">Start your wellness journey today</p>
